...
lr = args.lr
epochs = args.epochs
model = AmRippleGCN(num_feat=num_feat, num_hidden=args.hidden_dim, alpha=args.alpha, beta=args.beta,
...
if __name__ == '__main__':
    ...
    #       GPU=GPU)
    trainNewRippleGCN(model, adj1=adj_mat, adj2=ripple_mat, Y=labels, idx_train=idx_train, idx_val=idx_val,
                      epochs=epochs,
    ...
    save_path = Path(__file__).parent / 'new_ripple_result' / (args.dataset + '_outVec.txt')
